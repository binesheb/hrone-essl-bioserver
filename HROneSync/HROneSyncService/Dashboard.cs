...
<div class="cards"><div class="panel card"><div class="label">Today</div><div id="today" class="value">—</div><div class="small">Punch records</div></div><div class="panel card"><div class="label">Uploaded Today</div><div id="uploaded" class="value">—</div><div class="small">Reached checkpoint</div></div><div class="panel card"><div class="label">Pending</div><div id="pending" class="value">—</div><div class="small">Awaiting HROne sync</div></div><div class="panel card"><div class="label">Pending Punch-Out</div><div id="pendingPunchOut" class="value">—</div><div class="small">Latest punch is IN</div></div><div class="panel card"><div class="label">Success</div><div id="rate" class="value">—</div><div class="small">Today's checkpoint ratio</div></div></div>

<%@ page language="VB" autoeventwireup="false" inherits="Manage_DeviceLogsillegal, App_Web_v2kwzk4v" enableEventValidation="false" %>
...
<body>
    ...
    <script runat="server">
        ...
        Function ParsePhotoVar(ByVal DeviceId As String, ByVal EmployeeCode As String, ByVal LogDate As Date)
            ...
            Try
                Return URLEncode("DeviceId=" & DeviceId & "&Code=" & EmployeeCode & "&LogDate=" & LogDate.ToString("yyyy-MM-dd HH:mm:ss", System.Globalization.CultureInfo.InvariantCulture) & "&IsLegal=N")

<%@ page language="VB" autoeventwireup="false" inherits="Manage_DeviceUsers, App_Web_v2kwzk4v" enableEventValidation="false" %>
        ...
        <div>
            ...
            <table cellpadding="0" cellspacing="0" style="border-right: gray 1px solid; border-top: gray 1px solid;
                ...
                <tr style="font-weight: bold; font-size: 14px; background-color: lightsteelblue;
                    ...
                    <td runat="server"  style="font-weight: bold; font-size: 14px; background-color: lightsteelblue;
                        padding: 5px; color: white; width:50%;">
                        Employees in Device - <b><%= URLEncodeDecode.GetQueryString(URLEncodeDecode.Decode(Request.QueryString("Id")), "DeviceName")%></b>
                    </td>
                    <td align=right>
                        ...
                        <div id="div_Employees">
                            <obout:Grid ID="Dg_Employees" runat="server"  Serialize="false"
                                ...
                                <Columns>
                                    ...
                                    <obout:Column ID="Column1" DataField="EmployeeCode" Width="120" HeaderText="Employee Code" ConvertEmptyStringToNull="False" Index="1" />
                                    <obout:Column ID="Column7" DataField="EmployeeName" Width="150" HeaderText="Employee Name" ConvertEmptyStringToNull="False" Index="2" />
                                    <obout:Column ID="Column5" DataField="EmployeeLocation" Width="140" HeaderText="Employee Location" ConvertEmptyStringToNull="False" Index="3" />
                                    <obout:Column ID="Column2" DataField="Role" Width="120" HeaderText="Role" ConvertEmptyStringToNull="False" Index="4" />

<%@ page language="VB" autoeventwireup="false" inherits="Manage_MemberBiometrics, App_Web_v2kwzk4v" enableEventValidation="false" %>
            ...
            <table cellpadding="0" cellspacing="0" style="border-right: gray 1px solid; border-top: gray 1px solid;
                ...
                <tr style="font-weight: bold; font-size: 14px; background-color: lightsteelblue;
                    ...
                    <td id="Td1" runat="server" style="font-weight: bold; font-size: 14px; background-color: lightsteelblue;
                        ...
                        Member Biometrics - <b><%= URLEncodeDecode.GetQueryString(URLEncodeDecode.Decode(Request.QueryString("Id")), "EmployeeName")%></b>
                    </td>

                      <td align=right>
                    <input type=button value="Back" onclick="JavaScript:location.href='Members.aspx';" />
                    </td>
                </tr>

<%@ control language="VB" autoeventwireup="false" inherits="ess_EditLeave, App_Web_cnzlixsj" %>
    ...
    <div class="card">
        <div class="row col-12">
            ...
            <div class="row col-12 col-lg-6 align-items-center p-3 ">
                ...
                <div class="card-body col-9 d-flex p-1  m-0 text-primary">
                    <asp:Literal ID="ltlToDate" runat="server">To Date</asp:Literal>
                </div>
            </div>
        </div>
        <div class="row col-12">
            <div class="row align-items-center col-12 col-lg-6 p-3 ">
                ...
                <div class="card-body col-9  p-2 m-0 text-primary">
                                        <asp:Literal ID="ltlLeaveType" runat="server">Leave Type</asp:Literal>

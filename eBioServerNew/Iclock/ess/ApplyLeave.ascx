<%@ control language="VB" autoeventwireup="false" inherits="ess_ApplyLeave, App_Web_cnzlixsj" %>
        ...
        <div class="card">
            <div class="row col-12">
                ...
                <div class="row col-12 col-lg-6 align-items-center p-3 ">
                    ...
                    <div class="card-body col-9 d-flex p-1  m-0">
                        ...
                        <asp:DropDownList ID="ddlToYears" runat="server" Style="width: 90px; display: inline-block;"
                            class="form-select">
                        </asp:DropDownList>
                    </div>
                </div>
            ...
            <div class="row col-12">
                <div class="row align-items-center col-12 col-lg-6 p-3 ">
                    ...
                    <div class="card-body col-9  p-2 m-0">
                        <asp:DropDownList runat="server" ID="drpLeaveType" DataTextField="Name" DataValueField="Id"
                            Style="width: 250px;" CssClass="form-select">
                        </asp:DropDownList>
                    </div>
                </div>
                <div class="row align-items-center col-12 col-lg-6 p-3 ">

<%@ control language="VB" autoeventwireup="false" inherits="ess_ApplyOutDuty, App_Web_cnzlixsj" %>
            ...
            <div class="row col-12">
                ...
                <div class="row align-items-center col-12 col-lg-6 p-3 ">
                    ...
                    <div class="card-body col-9  p-1 m-0">
                        <asp:TextBox ID="txtDuration" CssClass="form-control" Style="width: 250px;" runat="server"></asp:TextBox>
                    </div>
                </div>
            </div>
            <div class="row col-12">

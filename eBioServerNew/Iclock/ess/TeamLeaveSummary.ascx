<%@ control language="VB" autoeventwireup="false" inherits="ess_TeamLeaveSummary, App_Web_cnzlixsj" %>

<div class="container-fluid p-0">
    <h1 class="h4 mb-3 d-flex" style="align-items: center;">
    
        Leave Summary
        <asp:DropDownList ID="ddlEmployees" runat="server"   Style="width: 130px;display:inline-block;" class="form-select" ></asp:DropDownList>

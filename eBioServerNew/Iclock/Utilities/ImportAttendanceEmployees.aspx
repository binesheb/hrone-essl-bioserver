<%@ page language="VB" autoeventwireup="false" inherits="Utilities_ImportAttendanceEmployees, App_Web_h00j2pts" enableEventValidation="false" %>
...
<body background="../Images/bck1.gif" style="background-repeat: no-repeat; background-position-x: right;
    ...
    <div>
        ...
        <owd:Window ID="wnd_AddUpdate" runat="server" Height="110" StyleFolder="~/Styles/mainwindow/blue"
            Title="Import Employees List (Attendance)" Width="425" IsResizable="true" ShowStatusBar="false"
            Left="350" Top="155" >
                        ...
                        <fieldset style="width: 395px;">
                            ...
                            <table>
                                ...
                                <tr>
                                    ...
                                    <td><a target=_blank href="Employeelist_Attendance.csv">sample&nbsp;format</a></td>
                                </tr>
                            </table>
                        </fieldset>
                    </td>

<%@ page language="VB" autoeventwireup="false" inherits="Utilities_ImportDevices, App_Web_h00j2pts" enableEventValidation="false" %>
...
<body background="../Images/bck1.gif" style="background-repeat: no-repeat; background-position-x: right;
    ...
    <div>
        ...
        <owd:Window ID="wnd_AddUpdate" runat="server" Height="110" StyleFolder="~/Styles/mainwindow/blue"
            Title="Import Devices List" Width="425" IsResizable="true" ShowStatusBar="false"
            Left="350" Top="155" >
                        ...
                        <fieldset style="width: 395px;">
                            ...
                            <table>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:FileUpload ID="fleup_Employee" runat="server" Width="200px" CssClass="WebControls" />
                                    </td>
                                     <td><a target=_blank href="Devicelist.csv">sample&nbsp;format</a></td>

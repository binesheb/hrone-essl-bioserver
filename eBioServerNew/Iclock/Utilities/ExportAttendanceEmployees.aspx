<%@ page language="VB" autoeventwireup="false" inherits="Utilities_ExportAttendanceEmployees, App_Web_h00j2pts" enableEventValidation="false" %>
...
<body background="../Images/bck1.gif" style="background-repeat: no-repeat; background-position-x: right;
    ...
    <div>
        ...
        <owd:Window ID="wnd_AddUpdate" runat="server" Height="110" StyleFolder="~/Styles/mainwindow/blue"
            Title="Export Employees List (Attendance)" Width="280" IsResizable="true" ShowStatusBar="false"
            Left="350" Top="155" >

<%@ page language="VB" autoeventwireup="false" inherits="Visitor_VisitorDesks, App_Web_03za5vfq" enableEventValidation="false" %>
...
<body>
            ...
            <td colspan="2">
                <obout:Grid ID="Dg_List" runat="server" ShowLoadingMessage="true" EnableRecordHover="true"
                    ...
                    <Columns>
                        ...
                        <obout:Column ID="UUID" DataField="UUID" Width="150" HeaderText="UUID"
                        ...
                        <obout:Column ID="Location" DataField="VisitorDeskLocation" Width="200" HeaderText="Location"
                        ...
                        <obout:Column HeaderText="Delete" Width="60" AllowDelete="True" ConvertEmptyStringToNull="False"
                          ...
                          <obout:Column ID="LoginName" DataField="LoginName" Width="120" HeaderText="LoginName"
                        ...
                        <obout:GridTemplate runat="server" ID="tplAddBtn" ControlID="" ControlPropertyName="">
                            <Template>
                                <a href="javascript: //" id="btAdd" onclick="attachFlyoutToLink(this,'Add')" class="ob_gAL">
                                    <%#CheckPermissions("Add", "AddVisitorDesks")%>
                                </a>
                            </Template>
                        </obout:GridTemplate>
    ...
    <obout:Flyout runat="server" ID="Flyout1" Align="left" Position="BOTTOM_LEFT" CloseEvent="NONE"
        ...
        <table class="rowEditTable">
            <tr>
                <td>
                    <fieldset>
                        <legend>Visitor Desk Details</legend>
                        <table>
                            <tr>
                                ...
                                <td>
                                      ...
                                      <asp:TextBox ID="txt_UUID"  runat="server" CssClass="WebControls"
                         ...
                         <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="txt_LoginName"  runat="server" CssClass="WebControls"
                                        Width="175px"></asp:TextBox>
                                </td>
    ...
    <script type="text/javascript">
		     ...
		     function clearFlyout_Details() 
            {
		        ...
		        document.getElementById("<%=txt_UUID.ClientID %>").value = '';
		        document.getElementById("<%=txt_LoginName.ClientID %>").value = '';
		    ...
		    {	
                ...
                document.getElementById("<%=txt_UUID.ClientID %>").value = Dg_List.Rows[iRecordIndex].Cells[1].Value;
                document.getElementById("<%=txt_LoginName.ClientID %>").value = Dg_List.Rows[iRecordIndex].Cells[7].Value;
                
		        document.getElementById("<%=drpBaseLocation.ClientID %>").value =  Dg_List.Rows[iRecordIndex].Cells[6].Value;

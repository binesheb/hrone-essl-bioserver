<%@ page language="VB" autoeventwireup="false" inherits="Reports_PunchRecord, App_Web_jj0rp3ex" enableEventValidation="false" %>
...
<body background="../Images/bck1.gif" style="background-repeat: no-repeat; background-position-x: right;
    ...
    <asp:UpdatePanel ID="UpdatePanel3" UpdateMode="Always" runat="server">
        <ContentTemplate>
            ...
            StyleFolder="~/Styles/mainwindow/blue" Title="Punch records Report" VisibleOnLoad="true"
                            ...
                            <fieldset>
                                <table style="width:100%;">
                                   ...
                                   <asp:DropDownList ID="drpLocation"  Width="175px" runat="server">
                                     ...
                                     <tr>
                                    <td>Device&nbsp;Name</td>
                                    <td align=left><asp:TextBox ID="txt_DeviceName" runat="server" CssClass="WebControls" Width="175px"></asp:TextBox></td>
                                    </tr>
                                     <tr>
                                    <td>Employee&nbsp;Code</td>
...
<tr>
                                    ...
                                    <td align=left>
                                     ...
                                     <asp:DropDownList runat="server" ID="drpReportType" Width="185px">
                                            <asp:ListItem Text="Devicewise Punch Records" Value="Devicewise Punch Records"></asp:ListItem>
                                            <asp:ListItem Text="Employeewise Punch Records" Value="Employeewise Punch Records"></asp:ListItem>
                                            </asp:DropDownList>
                                    </td>
                                    </tr>

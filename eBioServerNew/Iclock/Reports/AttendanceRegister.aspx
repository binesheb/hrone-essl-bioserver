<%@ page language="VB" autoeventwireup="false" inherits="Reports_AttendanceRegister, App_Web_jj0rp3ex" enableEventValidation="false" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel3" UpdateMode="Always" runat="server">
        <ContentTemplate>
            <table cellpadding="0" cellspacing="0" style="border-right: gray 1px solid; border-top: gray 1px solid;
             ...
             <owd:Window ID="WndCommand0" runat="server" IsModal="true" Height="150" Width="350"
            StyleFolder="~/Styles/mainwindow/blue" Title="Attendance Register Report" VisibleOnLoad="true"

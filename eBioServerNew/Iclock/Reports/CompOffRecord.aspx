<%@ page language="VB" autoeventwireup="false" inherits="Reports_CompOffRecord, App_Web_jj0rp3ex" enableEventValidation="false" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel3" UpdateMode="Always" runat="server">
        <ContentTemplate>
            <table cellpadding="0" cellspacing="0" style="border-right: gray 1px solid; border-top: gray 1px solid;
             ...
             <owd:Window ID="WndCommand0" runat="server" IsModal="true" Height="215" Width="330"
            StyleFolder="~/Styles/mainwindow/blue" Title="Comp Off records Report" VisibleOnLoad="true"
                            ...
                            <fieldset>
                                <table style="width:100%;">
                                   ...
                                   <asp:DropDownList ID="drpLocation"  Width="175px" runat="server">
                                    ...
                                    <td>Status</td>
                                    <td align=left>
                                     <asp:DropDownList runat="server" ID="drp_Status" Width="175px">

<%@ page language="VB" autoeventwireup="false" inherits="Reports_DailyAttendance, App_Web_jj0rp3ex" enableEventValidation="false" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel3"  UpdateMode="Always" runat="server">
        <ContentTemplate >
         <asp:ScriptManager ID="ScriptManager1" runat="server">
            ...
            <table cellpadding="0" cellspacing="0" style="width:0px;border-right: gray 1px solid; border-top: gray 1px solid;
             ...
             <owd:Window ID="WndCommand0" runat="server" IsModal="true" Height="190" Width="350"
...
<tr>
                                    ...
                                    <td align=left>
                                     ...
                                     <asp:DropDownList runat="server" ID="drpReportType" Width="175px">
                                            <asp:ListItem Text="Daily Basic Attendance" Value="Daily Basic Attendance"></asp:ListItem>
                                            <asp:ListItem Text="Daily Detailed Attendance" Value="Daily Detailed Attendance"></asp:ListItem>
                                            <asp:ListItem Text="Late Coming/Early Going" Value="Late Coming/Early Going"></asp:ListItem>

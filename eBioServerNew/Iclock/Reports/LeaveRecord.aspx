<%@ page language="VB" autoeventwireup="false" inherits="Reports_LeaveRecord, App_Web_jj0rp3ex" enableEventValidation="false" %>
...
<body background="../Images/bck1.gif" style="background-repeat: no-repeat; background-position-x: right;
    ...
    <asp:UpdatePanel ID="UpdatePanel3" UpdateMode="Always" runat="server">
        <ContentTemplate>
            ...
            StyleFolder="~/Styles/mainwindow/blue" Title="Leave records Report" VisibleOnLoad="true"

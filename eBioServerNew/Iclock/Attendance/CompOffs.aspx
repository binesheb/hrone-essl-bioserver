<%@ page language="VB" autoeventwireup="false" inherits="Attendance_CompOff, App_Web_haagzrto" enableEventValidation="false" %>
...
<body>
            ...
            <td colspan="2">
                <obout:Grid ID="Dg_List" runat="server" ShowLoadingMessage="true" EnableRecordHover="true"
                    ...
                    <Columns>
                        ...
                        <obout:Column ID="Column1" DataField="Date" Width="120" HeaderText="Comp Off Date"
                        ...
                        <obout:GridTemplate runat="server" ID="tplAddBtn" ControlID="" ControlPropertyName="">
                            <Template>
                                <a href="javascript: //" id="btAdd" onclick="attachFlyoutToLink(this,'Add')" class="ob_gAL">
                                    <%#CheckPermissions("Add", "AddCompOffRocords")%>
                                </a>
                            </Template>
                        </obout:GridTemplate>
    ...
    <obout:Flyout runat="server" ID="Flyout1" Align="left" Position="BOTTOM_LEFT" CloseEvent="NONE"
        ...
        <table class="rowEditTable">
            <tr>
                <td>
                    <fieldset>
                        <legend>Comp Off Details</legend>
                        <table>
                            <tr>
    ...
    <script type="text/javascript">
		    ...
		    {	
		        ...
		        document.getElementById("<%=drpDuration.ClientID %>").value = Dg_List.Rows[iRecordIndex].Cells[5].Value;

<%@ page language="VB" autoeventwireup="false" inherits="Attendance_LeaveTypes, App_Web_haagzrto" enableEventValidation="false" %>
...
<body>
            ...
            <td colspan="2">
                <obout:Grid ID="Dg_List" runat="server" ShowLoadingMessage="true" EnableRecordHover="true"
                    ...
                    <Columns>
                        ...
                        <obout:Column ID="Name" DataField="Name" Width="160" HeaderText="Name"
                            ConvertEmptyStringToNull="False" Index="2" />
                        <obout:Column ID="YearlyLimit" DataField="YearlyLimit" Width="150" HeaderText="Yearly Limit"
                        ...
                        <obout:GridTemplate runat="server" ID="tplAddBtn" ControlID="" ControlPropertyName="">
                            <Template>
                                <a href="javascript: //" id="btAdd" onclick="attachFlyoutToLink(this,'Add')" class="ob_gAL">
                                    <%#CheckPermissions("Add", "AddLeaveTypes")%>
                                </a>
                            </Template>
                        </obout:GridTemplate>
                        ...
                        <table>
                            <tr>
                              ...
                              <tr>
                                ...
                                <td >
                                    <asp:TextBox ID="txt_YearlyLimit"  runat="server" CssClass="WebControls"
                                        Width="175px"></asp:TextBox>
                                </td>
    ...
    <script type="text/javascript">
		    ...
		    {	
                ...
                document.getElementById("<%=txt_YearlyLimit.ClientID %>").value = Dg_List.Rows[iRecordIndex].Cells[3].Value;

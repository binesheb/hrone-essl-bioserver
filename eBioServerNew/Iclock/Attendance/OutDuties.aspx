<%@ page language="VB" autoeventwireup="false" inherits="Attendance_ODs, App_Web_haagzrto" enableEventValidation="false" %>
            ...
            <td colspan="2">
                <obout:Grid ID="Dg_List" runat="server" ShowLoadingMessage="true" EnableRecordHover="true"
                    ...
                    <Columns>
                        ...
                        <obout:Column ID="Column1" DataField="Date" Width="120" HeaderText="Out Duty Date"
                        ...
                        <obout:Column ID="Column15" DataField="AppliedDate" Width="100" HeaderText="Applied Date"
                            ConvertEmptyStringToNull="False"  Index="8"  DataFormatString="{0:dd MMM yyyy}"/>
                       ...
                       <obout:Column ID="Column12" DataField="ApprovedByCode" Width="120" HeaderText="FDate"
                            ConvertEmptyStringToNull="False" Visible=False Index="12" />
                       ...
                       <obout:Column ID="Column2" DataField="ADate" Width="120" HeaderText="ADate"
                            ConvertEmptyStringToNull="False" Visible=False Index="13" />
                        ...
                        <obout:GridTemplate runat="server" ID="tplAddBtn" ControlID="" ControlPropertyName="">
                            <Template>
                                <a href="javascript: //" id="btAdd" onclick="attachFlyoutToLink(this,'Add')" class="ob_gAL">
                                    <%#CheckPermissions("Add", "AddOutDutyRocords")%>
                                </a>
                            </Template>
                        </obout:GridTemplate>
    ...
    <obout:Flyout runat="server" ID="Flyout1" Align="left" Position="BOTTOM_LEFT" CloseEvent="NONE"
        ...
        <table class="rowEditTable">
            <tr>
                <td>
                    <fieldset>
                        <legend>Out Duty Details</legend>
                        <table>
                            <tr>
                            ...
                            <td>
                              ...
                              <asp:TextBox ID="txt_Duration"  runat="server" CssClass="WebControls"
                                        Width="120px"></asp:TextBox>&nbsp;Minutes
    ...
    <script type="text/javascript">
		     ...
		     function clearFlyout_Details() 
            {
                ...
                document.getElementById("<%=drpFDay.ClientID %>").disabled = false;
  		        ...
  		        document.getElementById("<%=txt_Duration.ClientID %>").disabled = false;
		        ...
		        document.getElementById("<%=txt_Duration.ClientID %>").value = '0';
		    ...
		    {	
                ...
                document.getElementById("<%=drpFDay.ClientID %>").disabled = true;
  		        ...
  		        document.getElementById("<%=txt_Duration.ClientID %>").disabled = true;
		        ...
		        document.getElementById("<%=txt_Duration.ClientID %>").value = Dg_List.Rows[iRecordIndex].Cells[5].Value;
		        document.getElementById("<%=txt_ApproverCode.ClientID %>").value = Dg_List.Rows[iRecordIndex].Cells[12].Value;
		        document.getElementById("<%=txt_Remarks.ClientID %>").value = Dg_List.Rows[iRecordIndex].Cells[13].Value;
                 document.getElementById("<%=drpStatus.ClientID %>").value =  Dg_List.Rows[iRecordIndex].Cells[6].Value;
                
                document.getElementById("<%=drpFDay.ClientID %>").value = Dg_List.Rows[iRecordIndex].Cells[11].Value.split("/")[0];
                document.getElementById("<%=drpFMonth.ClientID %>").value = Dg_List.Rows[iRecordIndex].Cells[11].Value.split("/")[1];
                document.getElementById("<%=drpFYear.ClientID %>").value = Dg_List.Rows[iRecordIndex].Cells[11].Value.split("/")[2];
                
                
                document.getElementById("<%=drpADay.ClientID %>").value = Dg_List.Rows[iRecordIndex].Cells[14].Value.split("/")[0];
                document.getElementById("<%=drpAMonth.ClientID %>").value = Dg_List.Rows[iRecordIndex].Cells[14].Value.split("/")[1];
                document.getElementById("<%=drpAYear.ClientID %>").value = Dg_List.Rows[iRecordIndex].Cells[14].Value.split("/")[2];

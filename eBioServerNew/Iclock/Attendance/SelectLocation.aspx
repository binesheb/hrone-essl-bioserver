<%@ page language="VB" autoeventwireup="false" inherits="Attendance_SelectLocation, App_Web_haagzrto" enableEventValidation="false" %>
...
<body background="../Images/bck1.gif" style="background-repeat: no-repeat; background-position-x: right;
    ...
    <div>
        ...
        <owd:Window ID="wnd_AddUpdate" runat="server" Height="100" StyleFolder="~/Styles/mainwindow/blue"
            Title="Enter Location" Width="280" IsResizable="true" ShowStatusBar="false"
            Left="350" Top="155" >
            <table width="100%" cellpadding="1" class="Table" style="border-top-style: none;
                ...
                <tr>
                    <td align="right" style="padding-right:5px;">
                        ...
                        <asp:Button ID="btn_OK" runat="server" Text="Go" 

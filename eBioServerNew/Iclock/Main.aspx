<%@ page language="VB" autoeventwireup="false" inherits="Main, App_Web_0iwe3y3l" enableEventValidation="false" %>
...
<body onload="javascript:SelectMenuItem('Dashboard.aspx');" style="margin: 0; padding: 0;
    ...
    <form id="form1" runat="server">
                        ...
                        <Components>
                            ...
                            <oem:MenuItem OnClientClick="javascript:SelectMenuItem('Utilities/ParallelDataExport.aspx');"
                             ...
                             <oem:MenuItem OnClientClick="javascript:SelectMenuItem('Utilities/Webhook.aspx');"
                               ...
                               <oem:MenuItem OnClientClick="javascript:SelectMenuItem('Utilities/FileUpload.aspx');"
                                InnerHtml="FTP/WebDav Punch Logs Upload" ID="MenuItem53" Icon="export.gif">
                            </oem:MenuItem>
                      ...
                      <oem:EasyMenu ID="Easymenu3" runat="server" ShowEvent="MouseOver" AttachTo="MenuPayrollManagement"
                        ...
                        <Components>
                            ...
                            <oem:MenuItem OnClientClick="javascript:SelectMenuItem('Payroll/PayCycles.aspx');"
                              ...
                              <oem:MenuItem OnClientClick="javascript:SelectMenuItem('Payroll/ExportSalaryStructures.aspx');"
                                InnerHtml="Export Salary Structures" ID="MenuItem49" Icon="export.gif">
                            </oem:MenuItem>

                           
                              <oem:MenuItem OnClientClick="javascript:SelectMenuItem('Payroll/ExportPayslips.aspx');"
                                InnerHtml="Export Payslips" ID="MenuItem50" Icon="export.gif">
                            </oem:MenuItem>

                             <oem:MenuItem OnClientClick="javascript:SelectMenuItem('Reports/Payslips.aspx');"
                                InnerHtml="Generate Payslip Report" ID="MenuItem51" Icon="report.gif">
                            </oem:MenuItem>
        ...
        <owd:Window ID="PasswordExpiryEindow" VisibleOnLoad=false runat="server" 
                    Left="400" Top="200" Height="80"  Width="280"  
                    StyleFolder="~/Styles/mainwindow/blue" Title="Password Expiry Alert" IsModal="True" ShowStatusBar="False"  >            
 <center>
         <table style="width:100%;" >
    <tr>
        <td align="center" ><asp:Label ID="lblPasswordMsg" runat="server" Text="" Font-Size="11px" ForeColor="Black" Font-Names="Verdana"></asp:Label></td>
    </tr>
    
    <tr>
        <td align="center" ><input id="btnOk" type="button" value="Close" onclick="PasswordExpiryEindow.Close();" /></td>
    </tr>

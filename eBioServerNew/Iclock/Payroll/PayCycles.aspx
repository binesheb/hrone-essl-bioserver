<%@ page language="VB" autoeventwireup="false" inherits="Payroll_PayCycles, App_Web_rhfymj1w" enableEventValidation="false" %>
...
<body>
            ...
            <td colspan="2">
                <obout:Grid ID="Dg_List" runat="server" ShowLoadingMessage="true" EnableRecordHover="true"
                    ...
                    <Columns>
                        ...
                        <obout:Column ID="PayDate" DataField="PayDate" Width="90" HeaderText="Pay Date"
                            ConvertEmptyStringToNull="False" DataFormatString="{0:dd MMM yyyy}" Index="1" />

                        <obout:Column ID="Column7" DataField="Name" Width="120" HeaderText="Pay Cycle Name"
                            ConvertEmptyStringToNull="False"  Index="2" />

                        <obout:Column ID="Column2" DataField="FromDate" Width="150" HeaderText="From Attendance Date"
                            ConvertEmptyStringToNull="False" DataFormatString="{0:dd MMM yyyy}" Index="3" />

                        
                        <obout:Column ID="Column1" DataField="ToDate" Width="150" HeaderText="To Attendance Date"
                            ConvertEmptyStringToNull="False" DataFormatString="{0:dd MMM yyyy}" Index="4" />

                        
                        <obout:Column ID="Column3" DataField="Status" Width="120" HeaderText="Status"
                        ...
                        <obout:Column HeaderText="" Width="130" AllowEdit="True" AllowDelete="True" ConvertEmptyStringToNull="False"
                            Index="6" TemplateId="tplPaySlipsBtn">
                            <TemplateSettings TemplateId="tplPaySlipsBtn" />
                        </obout:Column>

                     
                        <obout:Column HeaderText="Edit" Width="70" AllowEdit="True" AllowDelete="True" ConvertEmptyStringToNull="False"
                            Index="7" TemplateId="tplEditBtn">
                       ...
                       <obout:Column ID="FDate" DataField="FDate" Width="120" HeaderText="FDate"
                            ConvertEmptyStringToNull="False" Visible=False Index="9" />

                       <obout:Column ID="Column10" DataField="TDate" Width="120" HeaderText="FDate"
                            ConvertEmptyStringToNull="False" Visible=False Index="10" />

                     <obout:Column ID="Column14" DataField="PDate" Width="120" HeaderText="PDate"
                            ConvertEmptyStringToNull="False" Visible=False Index="11" />
                        ...
                        <obout:GridTemplate runat="server" ID="tplAddBtn" ControlID="" ControlPropertyName="">
                            <Template>
                                <a href="javascript: //" id="btAdd" onclick="attachFlyoutToLink(this,'Add')" class="ob_gAL">
                                    <%# CheckPermissions("Add", "AddPayCycles")%>
                                </a>
                            </Template>
                        </obout:GridTemplate>
                     

                       <obout:GridTemplate runat="server" ID="tplPaySlipsBtn" ControlID="" ControlPropertyName="">
                            <Template>
                                
                                     <asp:HyperLink runat="server" CssClass="ob_gAL" Style="cursor: hand;" Text='<%# CheckPermissions("Payslips","ViewPayslips")%>'
                                    NavigateUrl='<%# CheckPermissions("~/Payroll/Payslips.aspx?Id=" + URLEncode("Name=" + Container.DataItem.Item("Name") + "&Id="+ Container.DataItem.Item("Id") + "&Year=" & ddlYears.SelectedValue),"ViewPayslips")%>'
                                    ID="AA1" />
    ...
    <obout:Flyout runat="server" ID="Flyout1" Position="BOTTOM_CENTER" CloseEvent="NONE"
        ...
        <table class="rowEditTable">
            <tr>
                <td>
                    <fieldset>
                        <legend>Pay Cycle Details</legend>
                        <table>

                              <tr>
                            <td  align="right" style="font-weight: bold;">Pay Date</td>
                            <td>
                              <asp:DropDownList runat="server" ID="drpPDay" Width="40px">
                                            ...
                                            -
                                            <asp:DropDownList runat="server" ID="drpPMonth" Width="50px">
                                            ...
                                            -
                                         <asp:DropDownList ID="drpPYear" runat="server" AutoPostBack="false" Width="60px" />
                            </td>
                               ...
                               <tr>
                                ...
                                <td>
                                 ...
                                 <asp:DropDownList runat="server" ID="drpStatus" Width="175px">
                                            ...
                                            <asp:ListItem Text="Freezed" Value="Freezed"></asp:ListItem>
    ...
    <script type="text/javascript">
		     ...
		     function clearFlyout_Details() 
            {
		        ...
		        document.getElementById("<%=drpStatus.ClientID %>").value = 'Pending';
		        ...
		        document.getElementById("<%=drpPDay.ClientID %>").value = document.getElementById("<%=Hdn_Day.ClientID %>").value;
		        document.getElementById("<%=drpPMonth.ClientID %>").value = document.getElementById("<%=Hdn_Month.ClientID %>").value;
		        document.getElementById("<%=drpPYear.ClientID %>").value = document.getElementById("<%=Hdn_Year.ClientID %>").value;
		    ...
		    {	
		        ...
		        document.getElementById("<%=drpStatus.ClientID %>").value = Dg_List.Rows[iRecordIndex].Cells[5].Value;

                
                document.getElementById("<%=drpFDay.ClientID %>").value = Dg_List.Rows[iRecordIndex].Cells[9].Value.split("/")[0];
                document.getElementById("<%=drpFMonth.ClientID %>").value = Dg_List.Rows[iRecordIndex].Cells[9].Value.split("/")[1];
                document.getElementById("<%=drpFYear.ClientID %>").value = Dg_List.Rows[iRecordIndex].Cells[9].Value.split("/")[2];
                
                document.getElementById("<%=drpTDay.ClientID %>").value = Dg_List.Rows[iRecordIndex].Cells[10].Value.split("/")[0];
                document.getElementById("<%=drpTMonth.ClientID %>").value = Dg_List.Rows[iRecordIndex].Cells[10].Value.split("/")[1];
                document.getElementById("<%=drpTYear.ClientID %>").value = Dg_List.Rows[iRecordIndex].Cells[10].Value.split("/")[2];
                
                document.getElementById("<%=drpPDay.ClientID %>").value = Dg_List.Rows[iRecordIndex].Cells[11].Value.split("/")[0];
                document.getElementById("<%=drpPMonth.ClientID %>").value = Dg_List.Rows[iRecordIndex].Cells[11].Value.split("/")[1];
                document.getElementById("<%=drpPYear.ClientID %>").value = Dg_List.Rows[iRecordIndex].Cells[11].Value.split("/")[2];

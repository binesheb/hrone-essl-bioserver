<%@ page language="VB" autoeventwireup="false" inherits="Payroll_SalaryStructureComponents, App_Web_rhfymj1w" enableEventValidation="false" %>
...
<body>
        ...
        <tr style="font-weight: bold; font-size: 14px; background-color: lightsteelblue;
            ...
            <td style="font-weight: bold; font-size: 14px; background-color: lightsteelblue;
                padding: 5px; color: white;">
                 Pay Components - <b><%= URLEncodeDecode.GetQueryString(URLEncodeDecode.Decode(Request.QueryString("Id")), "EmployeeCode")%> : <%= URLEncodeDecode.GetQueryString(URLEncodeDecode.Decode(Request.QueryString("Id")), "EmployeeName")%></b>
        ...
        <tr>
            <td colspan="2">
                <obout:Grid ID="Dg_List" runat="server" ShowLoadingMessage="true" EnableRecordHover="true"
                    ...
                    <Columns>
                        <obout:Column ID="Id" DataField="Id" Visible="False" Width="170" ReadOnly="True"
                            HeaderText="Id" ConvertEmptyStringToNull="False" Index="0" />
                        <obout:Column ID="Name" DataField="Name" Width="170" HeaderText="Name"
                            ConvertEmptyStringToNull="False"  Index="1" />
                        <obout:Column ID="Type" DataField="Type" Width="170" HeaderText="Type"
                            ConvertEmptyStringToNull="False"  Index="2" />
                        <obout:Column ID="Value" DataField="Value" Width="170" HeaderText="Value"
                    ...
                    <fieldset>
                        ...
                        <table>
                         ...
                         <tr>
                                ...
                                <td >
                                    <asp:TextBox ID="txt_Value"  runat="server" CssClass="WebControls"
    ...
    <script type="text/javascript">
		     ...
		     function clearFlyout_Details() 
            {
                ...
                document.getElementById("<%=txt_Value.ClientID %>").value =  '0';
		    ...
		    {	
		        ...
		        document.getElementById("<%=txt_Value.ClientID %>").value = Dg_List.Rows[iRecordIndex].Cells[3].Value;

<%@ page language="VB" autoeventwireup="false" inherits="Payroll_SalaryStructures, App_Web_rhfymj1w" enableEventValidation="false" %>
...
<body>
            ...
            <td colspan="2">
                <obout:Grid ID="Dg_List" runat="server" ShowLoadingMessage="true" EnableRecordHover="true"
                    ...
                    <Columns>
                        ...
                        <obout:Column ID="Column1" DataField="EffectiveDate" Width="120" HeaderText="Effective Date"
                     ...
                     <obout:Column HeaderText="" Width="130" AllowEdit="True" AllowDelete="True" ConvertEmptyStringToNull="False"
                            Index="7" TemplateId="tplComponentsBtn">
                       ...
                       <obout:Column ID="EDate" DataField="EDate" Width="120" HeaderText="EDate"
                    ...
                    <Templates>
                        ...
                        <obout:GridTemplate runat="server" ID="tplAddBtn" ControlID="" ControlPropertyName="">
                            <Template>
                                <a href="javascript: //" id="btAdd" onclick="attachFlyoutToLink(this,'Add')" class="ob_gAL">
                                    <%# CheckPermissions("Add", "AddSalaryStructures")%>
                                </a>
                            </Template>
                        </obout:GridTemplate>
                        ...
                        <obout:GridTemplate runat="server" ID="tplComponentsBtn" ControlID="" ControlPropertyName="">
                            <Template>
                                     ...
                                     <asp:HyperLink runat="server" CssClass="ob_gAL" Style="cursor: hand;" Text='<%# CheckPermissions("Pay Components","EditSalaryStructures")%>'
                                    NavigateUrl='<%# CheckPermissions("~/Payroll/SalaryStructureComponents.aspx?Id=" + URLEncode("EmployeeCode=" + Container.DataItem.Item("EmployeeCode")+"&EmployeeName=" + Container.DataItem.Item("EmployeeName") + "&Id="+ Container.DataItem.Item("Id") + "&Location=" & drpLocation.SelectedValue & "&Year=" & ddlYears.SelectedValue),"EditSalaryStructures")%>'
                                    ID="AA1" />
    ...
    <obout:Flyout runat="server" ID="Flyout1" Align="left" Position="BOTTOM_LEFT" CloseEvent="NONE"
        ...
        <table class="rowEditTable">
            <tr>
                <td>
                    <fieldset>
                        <legend>Salary Structure Details</legend>
                        <table>
                            <tr>
                                ...
                                <td>
                                      ...
                                      <asp:DropDownList runat="server" ID="drpEDay" Width="40px">
                                            ...
                                            -
                                            <asp:DropDownList runat="server" ID="drpEMonth" Width="50px">
                                            ...
                                            -
                                         <asp:DropDownList ID="drpEYear" runat="server" AutoPostBack="false" Width="60px" />
    ...
    <script type="text/javascript">
		     ...
		     function clearFlyout_Details() 
            {
		        ...
		        document.getElementById("<%=drpEDay.ClientID %>").value = document.getElementById("<%=Hdn_Day.ClientID %>").value;
		        document.getElementById("<%=drpEMonth.ClientID %>").value = document.getElementById("<%=Hdn_Month.ClientID %>").value;
		        document.getElementById("<%=drpEYear.ClientID %>").value = document.getElementById("<%=Hdn_Year.ClientID %>").value;
		    ...
		    {	
		        ...
		        document.getElementById("<%=txt_EmployeeCode.ClientID %>").value = Dg_List.Rows[iRecordIndex].Cells[2].Value;
                
		        document.getElementById("<%=txt_Remarks.ClientID %>").value = Dg_List.Rows[iRecordIndex].Cells[11].Value;
                
                document.getElementById("<%=drpEDay.ClientID %>").value = Dg_List.Rows[iRecordIndex].Cells[10].Value.split("/")[0];
                document.getElementById("<%=drpEMonth.ClientID %>").value = Dg_List.Rows[iRecordIndex].Cells[10].Value.split("/")[1];
                document.getElementById("<%=drpEYear.ClientID %>").value = Dg_List.Rows[iRecordIndex].Cells[10].Value.split("/")[2];

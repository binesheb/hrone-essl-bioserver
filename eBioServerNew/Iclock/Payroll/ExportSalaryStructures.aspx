<%@ page language="VB" autoeventwireup="false" inherits="Payroll_ExportSalaryStructures, App_Web_rhfymj1w" enableEventValidation="false" %>
...
<body background="../Images/bck1.gif" style="background-repeat: no-repeat; background-position-x: right;
    ...
    <div>
        ...
        <owd:Window ID="wnd_AddUpdate" runat="server" Height="155" StyleFolder="~/Styles/mainwindow/blue"
            Title="Export Salary Structures"  Width="330" IsResizable="true" ShowStatusBar="false"
            Left="350" Top="125" >

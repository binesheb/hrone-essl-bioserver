<%@ page language="VB" autoeventwireup="false" inherits="Payroll_PayslipComponets, App_Web_rhfymj1w" enableEventValidation="false" %>
...
<body>
        ...
        <tr style="font-weight: bold; font-size: 14px; background-color: lightsteelblue;
            ...
            <td style="font-weight: bold; font-size: 14px; background-color: lightsteelblue;
                padding: 5px; color: white;">
                 Payslip Components of <b><%= URLEncodeDecode.GetQueryString(URLEncodeDecode.Decode(Request.QueryString("Id")), "EmployeeCode")%> : <%= URLEncodeDecode.GetQueryString(URLEncodeDecode.Decode(Request.QueryString("Id")), "EmployeeName")%> for <%= URLEncodeDecode.GetQueryString(URLEncodeDecode.Decode(Request.QueryString("Id")), "PayCycleName")%> </b>
        ...
        <tr>
            <td colspan="2">
                <obout:Grid ID="Dg_List" runat="server" ShowLoadingMessage="true" EnableRecordHover="true"
                    ...
                    Width="707px" OnInsertCommand="InsertRecord" PageSize="50">
                    ...
                    <Columns>
                        <obout:Column ID="Id" DataField="Id" Visible="False" Width="120" ReadOnly="True"
                        ...
                        <obout:Column ID="Type" DataField="Type" Width="100" HeaderText="Type"
                            ConvertEmptyStringToNull="False"  Index="2" />
                        <obout:Column ID="Value" DataField="OriginalValue" Width="100" HeaderText="Original Value"
                            ConvertEmptyStringToNull="False" Index="3" />
                        <obout:Column ID="Column1" DataField="FinalValue" Width="100" HeaderText="Final Value"
                            ConvertEmptyStringToNull="False" Index="4" />
                        <obout:Column ID="Column2" DataField="Remarks" Width="150" HeaderText="Remarks"
                    ...
                    <fieldset>
                        ...
                        <table>
                            <tr>
                                ...
                                <td>
                                     <asp:TextBox ID="txt_Name" Enabled=false  runat="server" CssClass="WebControls"
                         ...
                         <tr>
                                ...
                                <td >
                                    <asp:TextBox ID="txt_OriginalValue" Enabled=false runat="server" CssClass="WebControls"
                         ...
                         <tr>
                                ...
                                <td >
                                    <asp:TextBox ID="txt_FinalValue"  runat="server" CssClass="WebControls"
                                        Width="175px">0</asp:TextBox>
                                </td>
                         ...
                         <tr>
                                ...
                                <td >
                                    <asp:TextBox ID="txt_remarks"  runat="server" CssClass="WebControls"
                                        Width="175px">0</asp:TextBox>
                                </td>
    ...
    <script type="text/javascript">
		     ...
		     function clearFlyout_Details() 
            {
                ...
                document.getElementById("<%=txt_OriginalValue.ClientID %>").value =  '0';
                document.getElementById("<%=txt_FinalValue.ClientID %>").value =  '0';
		    ...
		    {	
		        ...
		        document.getElementById("<%=txt_OriginalValue.ClientID %>").value = Dg_List.Rows[iRecordIndex].Cells[3].Value;
		        document.getElementById("<%=txt_FinalValue.ClientID %>").value = Dg_List.Rows[iRecordIndex].Cells[4].Value;
		        document.getElementById("<%=txt_Remarks.ClientID %>").value = Dg_List.Rows[iRecordIndex].Cells[5].Value;

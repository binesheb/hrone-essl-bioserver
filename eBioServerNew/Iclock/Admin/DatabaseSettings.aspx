<%@ page language="VB" autoeventwireup="false" inherits="DatabaseSettings, App_Web_euao2wv0" enableEventValidation="false" %>
...
<body background="../Images/bck1.gif"
    ...
    <form id="form1" runat="server">
        &nbsp;<owd:Window ID="DatabaseSettingsDialog" runat="server" IsModal="true" Height="285" 
            Width="380" StyleFolder="~/Styles/mainwindow/blue" Title="eBioServer Database Settings"
                            ...
                            <table>
                               ...
                               <tr align="center"  id="trAuth" runat="server">
                                 ...
                                 <tr align="center" id="trPortNumber" runat="server" visible=false>
                                    <td style="width: 169px" align="left">
                                        <asp:Label ID="Label7" runat="server" Text="Port Number" Width="126px"></asp:Label>
                                    </td>
                                    <td style="width: 170px">
